...
export const CartProvider = ({ children }) => {
  ...
  const addToCart = (item, quantity = 1, customizations = {}) => {
    // For simplicity, we'll use item id as a unique key for items without customizations
    // A more robust solution would generate a unique ID based on the item and its customizations
